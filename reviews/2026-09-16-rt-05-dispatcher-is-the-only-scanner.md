...
RT-05 closed as part of the RT-04 change. The design reasoning, the market review, the
...
See `../tests/TC-RT-05-dispatcher-is-the-only-scanner.md` for this row's own evidence and for what is explicitly **not**
claimed by it.
