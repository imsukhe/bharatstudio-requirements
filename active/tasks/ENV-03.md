# ENV-03 — measurement environment lane

**Authority:** [`../launch/07_BUILD_BOOTSTRAP_AUTHORITY.md`](../launch/07_BUILD_BOOTSTRAP_AUTHORITY.md) §3
**Status:** `Blocked — Razorpay sandbox reference/credentials unavailable`
...
| **Acceptance test** | infra validator `../bharatstudio-infra/tools/validate-measurement-manifest.mjs --template` validates the manifest; Alerts runner `../bharatstudio-alerts/scripts/measurement/run-local-measurement.sh --artifact /tmp/ENV-03.json` emits the redacted artifact |
| **Evidence location** | `tests/TC-ENV-03-measurement-environment.md` and corresponding review |
...
Razorpay sandbox reference validation only; credentials/provider execution remains blocked.
