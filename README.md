...
This is the sole active requirements authority for all BharatStudio repositories.
...
- `tasks/`, `tests/`, `reviews/` — minimal cross-repository execution artifacts.
- `archive/` — superseded documents, never an active authority.

Never copy an old FRD wholesale into this repository. Extract only the exact approved and still-pending section, preserve the legacy path/heading, and record why the slice remains active.
